...
void Network::SendExitNotification(void)
{
...
void Network::ReadDeltaMoveCommand(DreamMessage *mes, ServerSideClient *client)
{
	int flags = 0;
...
void Network::BuildMoveCommand(DreamMessage *mes, ServerSideClient *client)
{
	// Add to the message
	// Key
...
void Network::BuildDeltaMoveCommand(DreamMessage *mes, ServerSideClient *client)
{
	int flags = 0;
