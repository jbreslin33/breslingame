...
void Server::ShutdownNetwork(void)
{
...
void Server::CalculateVelocity(ServerSideCommand *command, float frametime)
{
...
void Server::MovePlayer(ServerSideClient *client)
{
...
void Server::RemoveClient(struct sockaddr *address)
{
	ServerSideClient *list = clientList;
