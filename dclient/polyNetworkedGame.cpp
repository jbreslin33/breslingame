...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::CheckPredictionError(int a)
{
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::ReadPackets(void)
{
	char data[1400];
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::SendCommand(void)
{
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::SendRequestNonDeltaFrame(void)
{
	char data[1400];
	dreamMessage message;
	message.Init(data, sizeof(data));
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::Connect(void)
{
	if(init)
	{
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::Disconnect(void)
{
	if(!init)
		return;
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::ReadMoveCommand(dreamMessage *mes, clientData *client)
{
	// Key
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::ReadDeltaMoveCommand(dreamMessage *mes, clientData *client)
{
	int processedFrame;
	int flags = 0;
...
// Desc:
//-----------------------------------------------------------------------------
void PolyNetworkedGame::BuildDeltaMoveCommand(dreamMessage *mes, clientData *theClient)
{
	int flags = 0;
